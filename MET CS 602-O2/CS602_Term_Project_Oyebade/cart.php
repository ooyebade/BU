...
if (isset($_POST['product_id'], $_POST['quantity']) && is_numeric($_POST['product_id']) && is_numeric($_POST['quantity'])) {
    ...
    if ($product && $quantity > 0) {
        ...
        if (!isset($_SESSION['cart'])) {
            // session variable doesnt exist, create it
            $_SESSION['cart'] = [];
        }
...
// Update product quantities in cart if the user clicks the "Update" button on the cart page
...
?>
<?=main_header('Shop-Shopping Kart')?>
    ...
    <form action="" method="post">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" style="text-align:center;">You have no products added in your cart...</td>
                </tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <?php endif; ?>
                    <td class="quantity">
                        <input type="number" name="quantity-<?=$num?>" value="<?=$product['quantity']?>" min="1" <?php if ($product['quantity'] != -1): ?>max="<?=$product['quantity']?>"<?php endif; ?> placeholder="Quantity" required>
                    </td>
                    <?php if ($product['options_price'] > 0): ?>
